...
<pre><code>  (jsown:parse "{\"foo\":\"bar\",\"frolic\":100,\"fragrance\":10.01,\"for\":\"markup\"}" "foo" "frolic" "fragrance")
  => (("foo" . "bar") ("frolic" . 100) ("fragrance" . 1001/100))</code></pre>
...
<pre><code>  (jsown:keywords '(("foo" . "bar") ("frolic" . 100) ("fragrance" . 1001/100)))
...
<pre><code>  CL-USER> (jsown:do-json-keys (keyword value)
               '(("foo" . "bar") ("frolic" . 100) ("fragrance" . 1001/100))
...
<pre><code>  (jsown:val '(("foo" . "bar") ("frolic" . 100) ("fragrance" . 1001/100)) "frolic")
  => 100
  (setf (jsown:val '(("foo" . "bar") ("frolic" . 100) ("fragrance" . 1001/100)) "frolic") "I wasn't here before")
  => (("foo" . "bar") ("frolic" . "I wasn't here before") ("fragrance" . 1001/100))</code></pre>

You can build objects by using the @val@ function too, albeit it doesn't look really sexy.
<pre><code>  (setf (jsown:val (setf (jsown:val (setf (jsown:val nil "foo") "bar") "bang") (list 1 2 3 "foo" 4 5)) "bingo") 24.93)
...
<pre><code>  (jsown:to-json '(("bingo" . 24.93) ("bang" 1 2 3 "foo" 4 5) ("foo" . "bar")))
  => "{\"bingo\":24.93,\"bang\":[1,2,3,\"foo\",4,5],\"foo\":\"bar\"}"</code></pre>
